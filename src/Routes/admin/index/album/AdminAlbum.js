												...
												<td>
													<div className="action">
														<div onClick={() => this.drop_down('previview')} className="svg">
															<svg id={`${item.Id},${item.Title},${item.Image},${item.File}`} onClick={this.handelSetNow.bind()}
																width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
																<path id={`${item.Id},${item.Title},${item.Image},${item.File}`} onClick={this.handelSetNow.bind()}
