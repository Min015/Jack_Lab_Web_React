													...
													<td>
														<div className="action">
															<div onClick={() => this.drop_down('previview')} className="svg">
																<svg id={`${item.Id},${item.Title},${item.Image},${item.File}`} onClick={this.handleSetNow.bind()}
																	width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
																	<path id={`${item.Id},${item.Title},${item.Image},${item.File}`} onClick={this.handleSetNow.bind()}
						...
						<div className="window">
							<div className="form">
								...
								<div className='margin_t15'>
									...
									<div>{now === undefined ? "" : now.File} </div>
								</div>
								<div className='margin_t15'>
					...
					>
						<div className="window">
							<div className="form ablumform">
								...
								<div className='photo'>
									<img src={now === undefined ? "" : `http://jacklab.ddns.net/${now.Image}`} alt="輪播圖" />
								</div>
							</div>
						</div>
					</div>
