...
export default class MeetingManage extends Component {
    ...
    render() {
        const { table_content, table_header, array } = this.state;
        return (
            <div>
                <AdminHeader />
                            ...
                            <table className="col-12 admin_table">
                                ...
                                <tbody>
                                    {table_content.map(
                                        (item, index) => {
                                            return (
                                                <tr key={index} className={array.includes(item.mM_id) ? "onchange" : ""}>
                                                    <td className="check">
                                                        <input type="checkbox"
                                                            id=""
                                                            name="Box"
                                                    ...
                                                    <td>{item.mM_title}</td>
                                                    <td>{item.mM_place}</td>
                                                    <td>{item.mM_recorder}</td>
                                                    <td>{item.mM_date}</td>
                                                    <td>
                                                        <div className="action">
                                                            <Link to='/MeetingManage/MeetingInfo' className="svg">
