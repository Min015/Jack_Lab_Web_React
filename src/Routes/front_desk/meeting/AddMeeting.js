            ...
            >
              ...
              <div className="inputbox">
                <div className="set col-12">
                  ...
                  />
                  <label className="label">輸入會議主題<div className='error_msg'>*</div></label>
                </div>
              </div>
              {/* 輸入會議內容 */}
              <div className="inputbox">
                <div className="set col-12">
                  <textarea
                    ...
                    onChange={this.handleInputChange.bind(this)}
                  ></textarea>
                  <label className="label">輸入會議內容<div className='error_msg'>*</div></label>
                </div>
              </div>
              {/* 選擇會議時間地點 */}
              <div className="inputbox">
                <div className="set col-4">
                  <input
                    ...
                    onChange={this.handleInputChange.bind(this)}
                  />
                  <label className="label">選擇會議時間<div className='error_msg'>*</div></label>
                </div>
                <div className="set col-4">
                  <input type="text"
                    name="place"
                    ...
                    onChange={this.handleInputChange.bind(this)}
                  />
                  <label className="label">輸入會議地點<div className='error_msg'>*</div></label>
                </div>
              </div>
              {/* 參與人員 */}
              <div className="inputbox">
